...
import { mockFixtures, mockResults } from "@/lib/mockData"
...
export default function FixturesPage() {
  ...
  // Use mockFixtures for upcoming, mockResults for results
  const upcomingFixtures = mockFixtures.filter(f => f.status === "upcoming" || f.status === "live")
  const results = mockResults.filter(f => f.status === "final")
  const loading = false;
  const error = null;
                          ...
                          <TabsContent value="upcoming" className="space-y-6">
                            {loading ? (
                              ...
                              <div className="grid gap-4">
                                {upcomingFixtures.length === 0 && <div>No upcoming fixtures.</div>}
